...
I decided to look into more samples and surprise surprise, I found another peice of code that I hadn't seen before. In file MainActivity.java, it exfiltrates Signal and Whatsapp SQLite database (wabs.json, wab.json etc.) and uploads it to firebase. 
